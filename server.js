...
app.get('/logout',function(req,res) {
  ...
  req.session.uid = null;
    var deleteevents = require('./data/sessionuserevents.json');
  deleteevents.splice(0, deleteevents.length);
    var clearedevents = JSON.stringify(deleteevents, null, 4);
  fs.writeFileSync('./data/sessionuserevents.json', clearedevents, 'utf8');
  // req.session.destroy();
